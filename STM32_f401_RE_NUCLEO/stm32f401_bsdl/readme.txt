...
The STM32F401xx MCUs integrate two serially connected JTAG TAPs, the boundary scan
TAP (IR is 5-bit wide) and the CortexMx TAP (IR is 4-bit wide).

The package contains :

   + A BSDL File for the CortexMx TAP and is common to all STM32F401xx  devices
   + Boundary scan BSDL Files for each STM32F401xx device on different packages :
      o LQFP100
	  o LQFP64
	  o UFBGA100
	  o UQFN48
